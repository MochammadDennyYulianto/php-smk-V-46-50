...
<body>
            ...
            <?php 
                ...
                if (isset($_SESSION['pelanggan'])) {
                    echo '
                        ...
                        <div class="float-end me-4 mt-4"> Cart : ( <a href="?f=home&m=beli"> '.cart().' </a>) </div>
                        <div class="float-end me-4 mt-4"> <a href="?f=home&m=histori"> Histori </a> </div>
                    ';
                }else {
                    echo '
    ...
    <div class="row mt-5">
        <div class="col">
            <p class="text-center"> 2021 copyright@DennyYulianto.com</p>
        </div>
    </div>
